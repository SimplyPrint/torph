...
export type VerifyFn = () => { pass: boolean; detail: string };
export type VerifyDomFn = (root: HTMLElement) => { pass: boolean; detail: string };
...
export function combineResults(...results: { pass: boolean; detail: string }[]) {
